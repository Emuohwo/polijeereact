...
import Parties from "./PartiesUsers.jsx"
 ...
 */
export class PartiesPageUser extends Component {
    /**
...
export default connect(mapStateToProps, mapDispatchToProps)(PartiesPageUser);
